...
public class Rasterizer3D extends Rasterizer2D
{
    ...
    {
        anIntArray1472 = new int[Rasterizer2D.anInt1380];
        if(byte0 == 6)
        {
            byte0 = 0;
        } else
        ...
        for(int j = 0; j < Rasterizer2D.anInt1380; j++)
            anIntArray1472[j] = Rasterizer2D.anInt1379 * j;

        anInt1466 = Rasterizer2D.anInt1379 / 2;
        anInt1467 = Rasterizer2D.anInt1380 / 2;
    }
    ...
    public static final void method368(Archive class44, int i)
    {
        ...
        for(int j = 0; j < 50; j++)
            try
            {
                aClass30_Sub2_Sub1_Sub2Array1474[j] = new IndexedSprite(class44, String.valueOf(j), 0);
    ...
    public static final int[] method371(int i)
    {
        ...
        IndexedSprite class30_sub2_sub1_sub2 = aClass30_Sub2_Sub1_Sub2Array1474[i];
            ...
            int i2)
    {
        ...
        if(i <= j && i <= k)
        {
            if(i >= Rasterizer2D.anInt1382)
                return;
            if(j > Rasterizer2D.anInt1382)
                j = Rasterizer2D.anInt1382;
            if(k > Rasterizer2D.anInt1382)
                k = Rasterizer2D.anInt1382;
            if(j < k)
            {
                j1 = l <<= 16;
                i2 = k1 <<= 15;
                ...
                if(i != j && j3 < j2 || i == j && j3 > l2)
                {
                    k -= j;
                    j -= i;
                    for(i = anIntArray1472[i]; --j >= 0; i += Rasterizer2D.anInt1379)
                    {
                        method375(Rasterizer2D.anIntArray1378, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while(--k >= 0) 
                    {
                        method375(Rasterizer2D.anIntArray1378, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                        i += Rasterizer2D.anInt1379;
                    }
                    return;
                }
                k -= j;
                ...
                for(i = anIntArray1472[i]; --j >= 0; i += Rasterizer2D.anInt1379)
                {
                    method375(Rasterizer2D.anIntArray1378, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while(--k >= 0) 
                {
                    method375(Rasterizer2D.anIntArray1378, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if(i != k && j3 < j2 || i == k && l2 > j2)
            {
                j -= k;
                k -= i;
                for(i = anIntArray1472[i]; --k >= 0; i += Rasterizer2D.anInt1379)
                {
                    method375(Rasterizer2D.anIntArray1378, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            for(i = anIntArray1472[i]; --k >= 0; i += Rasterizer2D.anInt1379)
            {
                method375(Rasterizer2D.anIntArray1378, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && j2 < l2 || j == k && j2 > j3)
                {
                    i -= k;
                    k -= j;
                    for(j = anIntArray1472[j]; --k >= 0; j += Rasterizer2D.anInt1379)
                    {
                        method375(Rasterizer2D.anIntArray1378, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while(--i >= 0) 
                    {
                        method375(Rasterizer2D.anIntArray1378, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                        j += Rasterizer2D.anInt1379;
                    }
                    return;
                }
                i -= k;
                ...
                for(j = anIntArray1472[j]; --k >= 0; j += Rasterizer2D.anInt1379)
                {
                    method375(Rasterizer2D.anIntArray1378, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while(--i >= 0) 
                {
                    method375(Rasterizer2D.anIntArray1378, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if(j2 < l2)
            {
                k -= i;
                i -= j;
                for(j = anIntArray1472[j]; --i >= 0; j += Rasterizer2D.anInt1379)
                {
                    method375(Rasterizer2D.anIntArray1378, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            for(j = anIntArray1472[j]; --i >= 0; j += Rasterizer2D.anInt1379)
            {
                method375(Rasterizer2D.anIntArray1378, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if(i < j)
        {
            ...
            if(l2 < j3)
            {
                j -= i;
                i -= k;
                for(k = anIntArray1472[k]; --i >= 0; k += Rasterizer2D.anInt1379)
                {
                    method375(Rasterizer2D.anIntArray1378, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while(--j >= 0) 
                {
                    method375(Rasterizer2D.anIntArray1378, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
                    k += Rasterizer2D.anInt1379;
                }
                return;
            }
            j -= i;
            ...
            for(k = anIntArray1472[k]; --i >= 0; k += Rasterizer2D.anInt1379)
            {
                method375(Rasterizer2D.anIntArray1378, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while(--j >= 0) 
            {
                method375(Rasterizer2D.anIntArray1378, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if(l2 < j3)
        {
            i -= j;
            j -= k;
            for(k = anIntArray1472[k]; --j >= 0; k += Rasterizer2D.anInt1379)
            {
                method375(Rasterizer2D.anIntArray1378, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        for(k = anIntArray1472[k]; --j >= 0; k += Rasterizer2D.anInt1379)
        {
            method375(Rasterizer2D.anIntArray1378, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
        ...
        if(aBoolean1464)
        {
            ...
            if(aBoolean1462)
            {
                if(i1 - l > 3)
                    ...
                    l1 = 0;
                if(i1 > Rasterizer2D.anInt1385)
                    i1 = Rasterizer2D.anInt1385;
                if(l < 0)
                {
                    j1 -= l * l1;
                    l = 0;
    ...
    public static final void method376(int i, int j, int k, int l, int i1, int j1, int k1)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && j2 < l1 || i == j && j2 > i2)
                {
                    ...
                    for(i = anIntArray1472[i]; --j >= 0; i += Rasterizer2D.anInt1379)
                    {
                        method377(Rasterizer2D.anIntArray1378, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }
                    ...
                    while(--k >= 0) 
                    {
                        method377(Rasterizer2D.anIntArray1378, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += Rasterizer2D.anInt1379;
                    }
                ...
                for(i = anIntArray1472[i]; --j >= 0; i += Rasterizer2D.anInt1379)
                {
                    method377(Rasterizer2D.anIntArray1378, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }
                ...
                while(--k >= 0) 
                {
                    method377(Rasterizer2D.anIntArray1378, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += Rasterizer2D.anInt1379;
                }
            ...
            if(i != k && j2 < l1 || i == k && i2 > l1)
            {
                ...
                for(i = anIntArray1472[i]; --k >= 0; i += Rasterizer2D.anInt1379)
                {
                    method377(Rasterizer2D.anIntArray1378, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
            ...
            for(i = anIntArray1472[i]; --k >= 0; i += Rasterizer2D.anInt1379)
            {
                method377(Rasterizer2D.anIntArray1378, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && l1 < i2 || j == k && l1 > j2)
                {
                    ...
                    for(j = anIntArray1472[j]; --k >= 0; j += Rasterizer2D.anInt1379)
                    {
                        method377(Rasterizer2D.anIntArray1378, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }
                    ...
                    while(--i >= 0) 
                    {
                        method377(Rasterizer2D.anIntArray1378, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += Rasterizer2D.anInt1379;
                    }
                ...
                for(j = anIntArray1472[j]; --k >= 0; j += Rasterizer2D.anInt1379)
                {
                    method377(Rasterizer2D.anIntArray1378, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }
                ...
                while(--i >= 0) 
                {
                    method377(Rasterizer2D.anIntArray1378, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += Rasterizer2D.anInt1379;
                }
            ...
            if(l1 < i2)
            {
                ...
                for(j = anIntArray1472[j]; --i >= 0; j += Rasterizer2D.anInt1379)
                {
                    method377(Rasterizer2D.anIntArray1378, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
            ...
            for(j = anIntArray1472[j]; --i >= 0; j += Rasterizer2D.anInt1379)
            {
                method377(Rasterizer2D.anIntArray1378, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
        ...
        if(i < j)
        {
            ...
            if(i2 < j2)
            {
                ...
                for(k = anIntArray1472[k]; --i >= 0; k += Rasterizer2D.anInt1379)
                {
                    method377(Rasterizer2D.anIntArray1378, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }
                ...
                while(--j >= 0) 
                {
                    method377(Rasterizer2D.anIntArray1378, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += Rasterizer2D.anInt1379;
                }
            ...
            for(k = anIntArray1472[k]; --i >= 0; k += Rasterizer2D.anInt1379)
            {
                method377(Rasterizer2D.anIntArray1378, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }
            ...
            while(--j >= 0) 
            {
                method377(Rasterizer2D.anIntArray1378, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += Rasterizer2D.anInt1379;
            }
        ...
        if(i2 < j2)
        {
            ...
            for(k = anIntArray1472[k]; --j >= 0; k += Rasterizer2D.anInt1379)
            {
                method377(Rasterizer2D.anIntArray1378, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
        ...
        for(k = anIntArray1472[k]; --j >= 0; k += Rasterizer2D.anInt1379)
        {
            method377(Rasterizer2D.anIntArray1378, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
            ...
            int l3, int i4, int j4, int k4)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && i8 < i7 || i == j && i8 > k7)
                {
                    ...
                    while(--j >= 0) 
                    {
                        method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                        k1 += j7;
                    ...
                    while(--k >= 0) 
                    {
                        method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
                        l1 += l7;
                ...
                while(--j >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                    k1 += j7;
                ...
                while(--k >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    i1 += k7;
                    i2 += j8;
                    l1 += l7;
            ...
            if(i != k && i8 < i7 || i == k && k7 > i7)
            {
                ...
                while(--k >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                    k1 += j7;
            ...
            while(--k >= 0) 
            {
                method379(Rasterizer2D.anIntArray1378, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
                k1 += j7;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && i7 < k7 || j == k && i7 > i8)
                {
                    ...
                    while(--k >= 0) 
                    {
                        method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                        l1 += l7;
                    ...
                    while(--i >= 0) 
                    {
                        method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                        i2 += j8;
                ...
                while(--k >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                    l1 += l7;
                ...
                while(--i >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
                    i2 += j8;
            ...
            if(i7 < k7)
            {
                ...
                while(--i >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                    l1 += l7;
            ...
            while(--i >= 0) 
            {
                method379(Rasterizer2D.anIntArray1378, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
                l1 += l7;
        ...
        if(i < j)
        {
            ...
            if(k7 < i8)
            {
                ...
                while(--i >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                    i2 += j8;
                ...
                while(--j >= 0) 
                {
                    method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
                    k1 += j7;
            ...
            while(--i >= 0) 
            {
                method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
                i2 += j8;
            ...
            while(--j >= 0) 
            {
                method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
                k1 += j7;
        ...
        if(k7 < i8)
        {
            ...
            while(--j >= 0) 
            {
                method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
                i2 += j8;
        ...
        while(--j >= 0) 
        {
            method379(Rasterizer2D.anIntArray1378, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
            i2 += j8;
    ...
    public static IndexedSprite aClass30_Sub2_Sub1_Sub2Array1474[] = new IndexedSprite[50];
