...
3. Moved desktop client Java sources into a standard Gradle source tree:
   - `server/moparscape/src/main/java/io/github/ffakira/moparscape/...`
...
2. Continue refactoring bootstrap/login/input on top of the normalized desktop client tree.
3. Plan a separate emulator packaging migration once the runtime behavior is more stable.
