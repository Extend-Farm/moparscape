...
class WorldSceneOcclusionPlannerTest {
  ...
  @Test
  void activatesHorizontalPlaneOccludersWhenTheCameraIsBelowThem() {
    ...
    WorldSceneOcclusionContext occlusionContext = WorldSceneOcclusionPlanner.plan(
        ...
        new WorldCameraState(-45.0f, 20.0f, 20.0f, -1.0f, 12.0f, 12.0f, 0.0f)
    );

    assertThat(occlusionContext.activeOccluders())
        .extracting(WorldSceneOccluder::type)
        .containsExactly(WorldSceneOccluderType.HORIZONTAL_PLANE);
    assertThat(WorldSceneOcclusionPlanner.isOccluded(
        occlusionContext,
        12.0f,
        4.5f,
        12.0f
  ...
  @Test
  void skipsHorizontalPlaneOccludersWhenTheCameraIsAlreadyAboveThem() {
    WorldScene worldScene = new WorldScene(
        "open-roofline",
        3200,
        3200,
