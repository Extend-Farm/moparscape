...
class GameClientCore extends GameShell implements SocialOutputPort, WidgetConditionPort
{
    private static final int LOGIN_SCREEN_WELCOME = 0;
    private static final int LOGIN_SCREEN_CREDENTIALS = 2;
    ...
    public final void method18(int i)
    {
        ...
        if(anInt1276 != -1)
            method105(8, 0, 0, Widget.aClass9Array210[anInt1276], 0);
        else
        if(anInt1042 != -1)
        {
            method105(8, 0, 0, Widget.aClass9Array210[anInt1042], 0);
        } else
        {
            ...
            for(int k = 0; k < 100; k++)
                if(chatMessages[k] != null)
                {
                    ...
                    {
                        if(i1 > 0 && i1 < 110)
                            class30_sub2_sub1_sub4.method385(0, chatMessages[k], i1, 822, 4);
                        j++;
                    }
                    if((l == 1 || l == 2) && (l == 1 || anInt1287 == 0 || anInt1287 == 1 && method109(false, s1)))
                    {
                        if(i1 > 0 && i1 < 110)
                        {
                            ...
                            class30_sub2_sub1_sub4.method385(255, chatMessages[k], i1, 822, j1);
                        }
                        j++;
                    }
                    ...
                    if(l == 6 && anInt1195 == 0 && anInt845 < 2)
                    {
                        if(i1 > 0 && i1 < 110)
                        {
                            ...
                            class30_sub2_sub1_sub4.method385(0x800000, chatMessages[k], i1, 822, 12 + class30_sub2_sub1_sub4.method383(anInt1116, "To " + s1));
                        }
                        j++;
                    }
                    ...
                    {
                        if(i1 > 0 && i1 < 110)
                            class30_sub2_sub1_sub4.method385(0x7e3200, s1 + " " + chatMessages[k], i1, 822, 4);
                        j++;
                    }
                }
            ...
            if(aClass30_Sub2_Sub4_Sub1_Sub2_1126 != null && aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703 != null)
                ...
                s = TextUtils.method587(-45804, loginUsername);
    ...
    {
        if(embeddedHostComponent != null)
            return new Socket(InetAddress.getByName(getConfiguredServerEndpoint().host()), port);
        if(SignLink.mainapp != null)
    ...
    private GameServerEndpoint getConfiguredServerEndpoint()
    {
        return GameServerEndpoint.fromConfiguredAddress(configuredServerAddress);
    }

    public final int getConfiguredGamePort()
    {
        return getConfiguredServerEndpoint().port();
    }
        ...
        } else
        {
            if(j == 1 && anInt1133 > 0)
            {
                ...
                if(i1 == 632 || i1 == 78 || i1 == 867 || i1 == 431 || i1 == 53 || i1 == 74 || i1 == 454 || i1 == 539 || i1 == 493 || i1 == 847 || i1 == 447 || i1 == 1125)
                {
                    ...
                    Widget class9 = Widget.aClass9Array210[j2];
                    if(class9.aBoolean259 || class9.aBoolean235)
                    {
                        ...
                        dragSlot = l1;
                        dragState = 2;
                        dragStartMouseX = super.anInt27;
                        dragPointerY = super.anInt28;
                        if(Widget.aClass9Array210[j2].anInt236 == anInt857)
                            dragState = 1;
                        if(Widget.aClass9Array210[j2].anInt236 == anInt1276)
                            dragState = 3;
                        return;
                    }
                }
    ...
    public final void method25(int i, int j)
    {
        ...
        int k = 0xfa0a1f01;
        Object obj = null;
        for(GroundItem class30_sub2_sub4_sub2 = (GroundItem)class19.last(); class30_sub2_sub4_sub2 != null; class30_sub2_sub4_sub2 = (GroundItem)class19.previous(false))
        {
        ...
        class19.addLast(-493, ((Node) (obj)));
        Object obj1 = null;
        Object obj2 = null;
        for(GroundItem class30_sub2_sub4_sub2_1 = (GroundItem)class19.last(); class30_sub2_sub4_sub2_1 != null; class30_sub2_sub4_sub2_1 = (GroundItem)class19.previous(false))
        {
        ...
        aClass25_946.method281((byte)7, i, i1, ((Renderable) (obj1)), method42(anInt918, j * 128 + 64, true, i * 128 + 64), ((Renderable) (obj2)), ((Renderable) (obj)), anInt918, j);
    }
    ...
    public final void method26(boolean flag, int i)
    {
        ...
        {
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[j]];
            ...
            if(class30_sub2_sub4_sub1_sub1 == null || !class30_sub2_sub4_sub1_sub1.method449(aBoolean1224) || class30_sub2_sub4_sub1_sub1.aClass5_1696.aBoolean93 != flag)
                continue;
            int l = ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 >> 7;
            int i1 = ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 >> 7;
            if(l < 0 || l >= 104 || i1 < 0 || i1 >= 104)
                continue;
            if(((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1540 == 1 && (((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 & 0x7f) == 64 && (((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 & 0x7f) == 64)
            {
    ...
    public final void method29(int i, int j, Widget class9, int k, int l, int i1, int j1)
    {
        ...
        for(int l1 = 0; l1 < k1; l1++)
        {
            ...
            Widget class9_1 = Widget.aClass9Array210[class9.anIntArray240[l1]];
                    ...
                    for(int l2 = 0; l2 < class9_1.anInt267; l2++)
                    {
                        for(int i3 = 0; i3 < class9_1.anInt220; i3++)
                        {
                            ...
                            if(k >= j3 && i1 >= k3 && k < j3 + 32 && i1 < k3 + 32)
                            {
                                ...
                                {
                                    ItemDefinition class8 = ItemDefinition.method198(class9_1.anIntArray253[k2] - 1);
                                    if(itemUseState == 1 && class9_1.aBoolean249)
                                    {
                                        if(class9_1.anInt250 != itemUseWidgetId || k2 != itemUseSlot)
                                        {
                                            aStringArray1199[anInt1133] = "Use " + itemUseItemName + " with @lre@" + class8.aString170;
    ...
    private final void method31(PacketBuffer class30_sub2_sub2, int i, int j)
    {
        ...
        for(int k = 0; k < anInt839; k++)
        {
            ...
            if(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub1Array835[l])).anInt1537 != anInt1161)
            {
        ...
        {
            SignLink.reporterror(loginUsername + " size mismatch in getnpcpos - pos:" + class30_sub2_sub2.anInt1406 + " psize:" + i);
            throw new RuntimeException("eek");
        }
        for(int i1 = 0; i1 < anInt836; i1++)
            if(aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[i1]] == null)
            {
                SignLink.reporterror(loginUsername + " null entry in npc list - pos:" + i1 + " size:" + anInt836);
                throw new RuntimeException("eek");
            }
        ...
        if(super.anInt26 == 1)
        {
            ...
            if(super.anInt27 >= 412 && super.anInt27 <= 512 && super.anInt28 >= 467 && super.anInt28 <= 499)
                if(anInt857 == -1)
                {
                    ...
                    aString881 = "";
                    aBoolean1158 = false;
                    for(int i = 0; i < Widget.aClass9Array210.length; i++)
                    {
                        if(Widget.aClass9Array210[i] == null || Widget.aClass9Array210[i].anInt214 != 600)
                            continue;
                        anInt1178 = anInt857 = Widget.aClass9Array210[i].anInt236;
                        break;
                    }
    ...
    public final void method34(int i)
    {
        ...
        for(int j = -1; j < anInt891 + anInt836; j++)
        {
            ...
            if(obj == null || !((Actor) (obj)).method449(aBoolean1224))
                continue;
            if(obj instanceof Npc)
            {
                NpcDefinition class5 = ((Npc)obj).aClass5_1696;
            ...
            if(j < anInt891)
            {
                ...
                {
                    method127(true, ((Actor) (obj)), ((Actor) (obj)).anInt1507 + 15);
                    if(anInt963 > -1)
                    {
            ...
            {
                NpcDefinition class5_1 = ((Npc)obj).aClass5_1696;
            ...
            if(((Actor) (obj)).aString1506 != null && (j >= anInt891 || anInt1287 == 0 || anInt1287 == 3 || anInt1287 == 1 && method109(false, ((Player)obj).aString1703)))
            {
                method127(true, ((Actor) (obj)), ((Actor) (obj)).anInt1507);
                if(anInt963 > -1 && anInt974 < anInt975)
                {
                    anIntArray979[anInt974] = aClass30_Sub2_Sub1_Sub4_1272.method384(((Actor) (obj)).aString1506, true) / 2;
                    ...
                    anIntArray982[anInt974] = ((Actor) (obj)).anInt1535;
                    aStringArray983[anInt974++] = ((Actor) (obj)).aString1506;
            ...
            if(((Actor) (obj)).anInt1532 > anInt1161)
            {
                method127(true, ((Actor) (obj)), ((Actor) (obj)).anInt1507 + 15);
                if(anInt963 > -1)
                {
                    int i1 = (((Actor) (obj)).anInt1533 * 30) / ((Actor) (obj)).anInt1534;
                    if(i1 > 30)
                        i1 = 30;
            ...
            for(int j1 = 0; j1 < 4; j1++)
                if(((Actor) (obj)).anIntArray1516[j1] > anInt1161)
                {
                    method127(true, ((Actor) (obj)), ((Actor) (obj)).anInt1507 / 2);
                    if(anInt963 > -1)
                    {
                        if(j1 == 1)
                            anInt964 -= 20;
                        ...
                        aClass30_Sub2_Sub1_Sub1Array987[((Actor) (obj)).anIntArray1515[j1]].method348(anInt963 - 12, 16083, anInt964 - 12);
                        aClass30_Sub2_Sub1_Sub4_1270.method381(0, String.valueOf(((Actor) (obj)).anIntArray1514[j1]), 23693, anInt964 + 4, anInt963);
                        aClass30_Sub2_Sub1_Sub4_1270.method381(0xffffff, String.valueOf(((Actor) (obj)).anIntArray1514[j1]), 23693, anInt964 + 3, anInt963 - 1);
                    }
                }
    ...
    public final void method35(boolean flag, long l)
    {
        try
        {
            ...
            {
                if(friendNameHashes[i] != l)
                    continue;
                friendCount--;
                aBoolean1153 = true;
                for(int j = i; j < friendCount; j++)
                {
                    friendDisplayNames[j] = friendDisplayNames[j + 1];
                    friendWorlds[j] = friendWorlds[j + 1];
                    friendNameHashes[j] = friendNameHashes[j + 1];
                }
    ...
    public final void method36(byte byte0)
    {
        ...
        if(anInt1189 != -1)
            method105(8, 0, 0, Widget.aClass9Array210[anInt1189], 0);
        else
        if(anIntArray1130[anInt1221] != -1)
            method105(8, 0, 0, Widget.aClass9Array210[anIntArray1130[anInt1221]], 0);
    ...
    public final void method38(byte byte0)
    {
        ...
        for(int i = -1; i < anInt891; i++)
        {
            ...
            if(i == -1)
                ...
                j = anIntArray892[i];
            Player class30_sub2_sub4_sub1_sub2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[j];
            if(class30_sub2_sub4_sub1_sub2 != null && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1535 > 0)
            {
                class30_sub2_sub4_sub1_sub2.anInt1535--;
                if(((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1535 == 0)
        ...
        for(int k = 0; k < anInt836; k++)
        {
            ...
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[l];
            if(class30_sub2_sub4_sub1_sub1 != null && ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1535 > 0)
            {
                class30_sub2_sub4_sub1_sub1.anInt1535--;
                if(((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1535 == 0)
    ...
    public final void method41(byte byte0, long l)
    {
        try
        {
            ...
            {
                friendDisplayNames[friendCount] = s;
                friendNameHashes[friendCount] = l;
    ...
    public final void method44(boolean flag)
    {
        ...
        if(!flag)
            return;
        aBoolean1157 = false;
        loginScreenState = LOGIN_SCREEN_CREDENTIALS;
        loginStatusPrimary = "";
        loginStatusSecondary = "Enter your username and password.";
   //     loginUsername = "";
   //     loginPassword = "";
        method23(false);
        aClass25_946.method274(619);
    ...
    private final void method46(int i, PacketBuffer class30_sub2_sub2, byte byte0)
    {
        ...
        while(class30_sub2_sub2.anInt1407 + 21 < i * 8) 
        {
            ...
            if(aClass30_Sub2_Sub4_Sub1_Sub1Array835[k] == null)
                aClass30_Sub2_Sub4_Sub1_Sub1Array835[k] = new Npc();
            ...
            class30_sub2_sub4_sub1_sub1.aClass5_1696 = NpcDefinition.method159(class30_sub2_sub2.method419(12, 0));
            ...
            class30_sub2_sub4_sub1_sub1.method445(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0] + i1, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0] + l, j1 == 1, false);
        }
    ...
    {
        if(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 >> 7 == anInt1261 && ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 >> 7 == anInt1262)
            anInt1261 = 0;
        int j = anInt891;
        if(i != 0)
        {
        ...
        for(int l = 0; l < j; l++)
        {
            ...
            if((aBoolean960 && anInt891 > 50 || anInt891 > 200) && !flag && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1517 == ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1511)
                class30_sub2_sub4_sub1_sub2.aBoolean1699 = true;
            int j1 = ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 >> 7;
            int k1 = ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 >> 7;
            ...
            {
                class30_sub2_sub4_sub1_sub2.aBoolean1699 = false;
                class30_sub2_sub4_sub1_sub2.anInt1709 = method42(anInt918, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, true, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550);
                aClass25_946.method286(60, anInt918, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, class30_sub2_sub4_sub1_sub2, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1552, class30_sub2_sub4_sub1_sub2.anInt1722, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550, class30_sub2_sub4_sub1_sub2.anInt1709, class30_sub2_sub4_sub1_sub2.anInt1719, class30_sub2_sub4_sub1_sub2.anInt1721, i1, class30_sub2_sub4_sub1_sub2.anInt1720, (byte)35);
                continue;
            }
            if((((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 & 0x7f) == 64 && (((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 & 0x7f) == 64)
            {
            ...
            class30_sub2_sub4_sub1_sub2.anInt1709 = method42(anInt918, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, true, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550);
            aClass25_946.method285(anInt918, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1552, (byte)6, class30_sub2_sub4_sub1_sub2.anInt1709, i1, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, 60, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550, class30_sub2_sub4_sub1_sub2, ((Actor) (class30_sub2_sub4_sub1_sub2)).aBoolean1541);
        }
    ...
    private final void method49(int i, byte byte0, PacketBuffer class30_sub2_sub2)
    {
        ...
        for(int j = 0; j < anInt893; j++)
        {
            ...
            Player class30_sub2_sub4_sub1_sub2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[k];
    ...
    public static final void main(String args[])
    {
        try
        {
            ...
            initializeStandaloneClientRuntime(GameServerEndpoint.DEFAULT_ADDRESS, null);
    ...
    protected static void initializeStandaloneClientRuntime() throws UnknownHostException
    {
        initializeStandaloneClientRuntime(GameServerEndpoint.DEFAULT_ADDRESS, null);
    }

    protected static void initializeStandaloneClientRuntime(String serverAddress, Component embeddedHostSurface) throws UnknownHostException
    {
   ...
   //     aBoolean959 = false;//free
        aBoolean959 = true;//members
        embeddedHostComponent = embeddedHostSurface;
        SignLink.mainapp = null;
        SignLink.storeid = 32;
        String socketHost = GameServerEndpoint.fromConfiguredAddress(serverAddress).host();
        SignLink.startpriv(InetAddress.getByName(socketHost));
    }

    static void clearEmbeddedHost()
    {
        embeddedHostComponent = null;
    }

    public final void configureBootstrapLogin(String username, String password, String serverAddress, boolean autoSubmit)
    {
        loginUsername = clampLoginInput(username, 12);
        loginPassword = clampLoginInput(password, 20);
        configuredServerAddress = normalizeConfiguredServerAddress(serverAddress);
        loginStatusPrimary = "";
        loginStatusSecondary = "Enter your username and password.";
        loginScreenState = LOGIN_SCREEN_CREDENTIALS;
        loginInputField = LOGIN_INPUT_USERNAME;
        loginAutoSubmitPending = autoSubmit && !loginUsername.isEmpty() && !loginPassword.isEmpty();
    }

    final LegacyLoginStatusSnapshot snapshotLegacyLoginStatus()
    {
        return new LegacyLoginStatusSnapshot(
            aBoolean1157,
            loginScreenState == LOGIN_SCREEN_CREDENTIALS,
            loginAutoSubmitPending,
            loginStatusPrimary,
            loginStatusSecondary
        );
    }

    private static String clampLoginInput(String value, int maximumLength)
    {
        if(value == null)
            return "";
        ...
        if(trimmedValue.length() <= maximumLength)
            ...
            return trimmedValue.substring(0, maximumLength);
    }

    private static String normalizeConfiguredServerAddress(String serverAddress)
    {
    ...
    public final void method53(int i)
    {
        ...
        if(anInt1023 == 1)
        {
            ...
            {
                SignLink.reporterror(loginUsername + " glcfb " + aLong1215 + "," + j + "," + aBoolean960 + "," + aClass14Array970[0] + "," + aClass42_Sub1_1068.method552() + "," + anInt918 + "," + anInt1069 + "," + anInt1070);
                aLong824 = System.currentTimeMillis();
            }
        }
    ...
    public final void method55(int i)
    {
        while(i >= 0) 
            method6();
        for(Projectile class30_sub2_sub4_sub4 = (Projectile)aClass19_1013.last(); class30_sub2_sub4_sub4 != null; class30_sub2_sub4_sub4 = (Projectile)aClass19_1013.previous(false))
            ...
            if(anInt1161 >= class30_sub2_sub4_sub4.anInt1571)
            {
                ...
                {
                    Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[class30_sub2_sub4_sub4.anInt1590 - 1];
                    if(class30_sub2_sub4_sub1_sub1 != null && ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 >= 0 && ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 < 13312 && ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 >= 0 && ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 < 13312)
                        class30_sub2_sub4_sub4.method455(anInt1161, ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551, method42(class30_sub2_sub4_sub4.anInt1597, ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551, true, ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550) - class30_sub2_sub4_sub4.anInt1583, ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550, (byte)-83);
                }
                if(class30_sub2_sub4_sub4.anInt1590 < 0)
                {
                    ...
                    if(class30_sub2_sub4_sub1_sub2 != null && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 >= 0 && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 < 13312 && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 >= 0 && ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 < 13312)
                        class30_sub2_sub4_sub4.method455(anInt1161, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, method42(class30_sub2_sub4_sub4.anInt1597, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551, true, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550) - class30_sub2_sub4_sub4.anInt1583, ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550, (byte)-83);
                }
    ...
    {
        Widget class9 = Widget.aClass9Array210[i];
        for(int j = 0; j < class9.anIntArray240.length; j++)
        {
            if(class9.anIntArray240[j] == -1)
                break;
            Widget class9_1 = Widget.aClass9Array210[class9.anIntArray240[j]];
    ...
    {
        if(!GameTickProcessor.processInboundPackets(this))
            return;
        ...
        if(selectedDragState != 0)
        {
            anInt1243++;
            if(anInt1243 >= 15)
            {
                if(selectedDragState == 2)
                    aBoolean1153 = true;
        ...
        {
            anInt989++;
            if(super.anInt20 > dragStartMouseX + 5 || super.anInt20 < dragStartMouseX - 5 || super.anInt21 > dragPointerY + 5 || super.anInt21 < dragPointerY - 5)
                aBoolean1242 = true;
            if(super.anInt19 == 0)
            {
                if(dragState == 2)
                ...
                if(aBoolean1242 && anInt989 >= 5)
                {
                    anInt1067 = -1;
                    method82(0);
                    if(anInt1067 == dragWidgetId && anInt1066 != dragSlot)
                    {
                        Widget class9 = Widget.aClass9Array210[dragWidgetId];
                        int j1 = 0;
                        ...
                        {
                            class9.method204(dragSlot, (byte)9, anInt1066);
                        }
                        aClass30_Sub2_Sub2_1192.method397((byte)6, 214);
                        aClass30_Sub2_Sub2_1192.method433(0, dragWidgetId);
                        aClass30_Sub2_Sub2_1192.method424(j1, 0);
                        aClass30_Sub2_Sub2_1192.method433(0, dragSlot);
        ...
        if(SceneGraph.anInt470 != -1)
        {
            ...
            boolean flag = method85(0, 0, 0, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 0, 0, k1, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], true, k);
    ...
    {
        SceneObjectSpawnRequest class30_sub1 = (SceneObjectSpawnRequest)aClass19_1179.last();
        while(i >= 0) 
        {
            for(int j = 1; j > 0; j++);
        }
        for(; class30_sub1 != null; class30_sub1 = (SceneObjectSpawnRequest)aClass19_1179.previous(false))
    ...
    public final boolean method66(int i, int j, int k, int l)
    {
        ...
        if(k1 == 10 || k1 == 11 || k1 == 22)
        {
            ...
            method85(2, 0, j2, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], i2, k2, j, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, k);
        } else
        {
            method85(2, l1, 0, -11308, k1 + 1, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 0, 0, j, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, k);
        }
        anInt914 = super.anInt27;
        anInt915 = super.anInt28;
        anInt917 = 2;
    ...
    public final void method68(int i)
    {
        ...
        aBoolean1157 = false;
        anInt1038 = 0;
        method84(loginUsername, loginPassword, true);
        if(!aBoolean1157)
            method44(true);
        try
        {
    ...
    public final void method69(int i, boolean flag)
    {
        ...
        if(l == 582)
        {
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
                aClass30_Sub2_Sub2_1192.method397((byte)6, 57);
                aClass30_Sub2_Sub2_1192.method432(-431, itemUseItemId);
                aClass30_Sub2_Sub2_1192.method432(-431, i1);
                aClass30_Sub2_Sub2_1192.method431(true, itemUseSlot);
                aClass30_Sub2_Sub2_1192.method432(-431, itemUseWidgetId);
            }
        }
        if(l == 234)
        {
            routeToTileAndMarkCursor(j, k);
        ...
        if(l == 62 && method66(i1, k, j, -770))
        {
            ...
            aClass30_Sub2_Sub2_1192.method399(itemUseWidgetId);
            ...
            aClass30_Sub2_Sub2_1192.method399(itemUseItemId);
        }
        if(l == 511)
        {
            boolean flag2 = method85(2, 0, 0, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 0, 0, k, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, j);
            if(!flag2)
                flag2 = method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, k, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, j);
            anInt914 = super.anInt27;
            anInt915 = super.anInt28;
            anInt917 = 2;
            anInt916 = 0;
            aClass30_Sub2_Sub2_1192.method397((byte)6, 25);
            aClass30_Sub2_Sub2_1192.method431(true, itemUseWidgetId);
            aClass30_Sub2_Sub2_1192.method432(-431, itemUseItemId);
            aClass30_Sub2_Sub2_1192.method399(i1);
            aClass30_Sub2_Sub2_1192.method432(-431, k + anInt1035);
            aClass30_Sub2_Sub2_1192.method433(0, itemUseSlot);
        ...
        if(l == 315)
        {
            Widget class9 = Widget.aClass9Array210[k];
            boolean flag8 = true;
        ...
        if(l == 561)
        {
            Player class30_sub2_sub4_sub1_sub2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 20)
        {
            Npc class30_sub2_sub4_sub1_sub1_1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_1 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 779)
        {
            Player class30_sub2_sub4_sub1_sub2_1 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_1 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 337 || l == 42 || l == 792 || l == 322)
            MenuActionExecutor.applySocialListAction(this, l, aStringArray1199[i]);
        if(l == 53)
        {
        ...
        if(l == 870)
        {
            ...
            aClass30_Sub2_Sub2_1192.method432(-431, itemUseSlot);
            aClass30_Sub2_Sub2_1192.method433(0, i1);
            aClass30_Sub2_Sub2_1192.method399(itemUseWidgetId);
            aClass30_Sub2_Sub2_1192.method431(true, itemUseItemId);
            aClass30_Sub2_Sub2_1192.method399(k);
            MenuActionExecutor.applyDragSelection(this, k, j);
        }
        if(l == 847)
        ...
        if(l == 626)
        {
            Widget class9_1 = Widget.aClass9Array210[k];
            anInt1136 = 1;
            anInt1137 = k;
        ...
        if(l == 27)
        {
            Player class30_sub2_sub4_sub1_sub2_2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_2 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_2)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_2)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 646)
        {
            aClass30_Sub2_Sub2_1192.method397((byte)6, 185);
            aClass30_Sub2_Sub2_1192.method399(k);
            Widget class9_2 = Widget.aClass9Array210[k];
        ...
        if(l == 225)
        {
            Npc class30_sub2_sub4_sub1_sub1_2 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_2 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_2)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_2)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 965)
        {
            Npc class30_sub2_sub4_sub1_sub1_3 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_3 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_3)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_3)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 413)
        {
            Npc class30_sub2_sub4_sub1_sub1_4 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_4 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_4)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_4)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 1025)
        {
            Npc class30_sub2_sub4_sub1_sub1_5 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_5 != null)
            {
                NpcDefinition class5 = class30_sub2_sub4_sub1_sub1_5.aClass5_1696;
                if(class5.anIntArray88 != null)
                    class5 = class5.method161(anInt877);
                if(class5 != null)
                {
        ...
        if(l == 412)
        {
            Npc class30_sub2_sub4_sub1_sub1_6 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_6 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_6)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_6)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 365)
        {
            Player class30_sub2_sub4_sub1_sub2_3 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_3 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_3)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_3)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 729)
        {
            Player class30_sub2_sub4_sub1_sub2_4 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_4 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_4)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_4)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 577)
        {
            Player class30_sub2_sub4_sub1_sub2_5 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_5 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_5)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_5)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 606)
        {
            ...
            if(j2 != -1)
                if(anInt857 == -1)
                {
                    ...
                    aBoolean1158 = false;
                    for(int i3 = 0; i3 < Widget.aClass9Array210.length; i3++)
                    {
                        if(Widget.aClass9Array210[i3] == null || Widget.aClass9Array210[i3].anInt214 != 600)
                            continue;
                        anInt1178 = anInt857 = Widget.aClass9Array210[i3].anInt236;
                        break;
                    }
        ...
        if(l == 491)
        {
            Player class30_sub2_sub4_sub1_sub2_6 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[i1];
            if(class30_sub2_sub4_sub1_sub2_6 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub2_6)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub2_6)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 639)
        {
            ...
            if(k2 != -1)
            {
                ...
                if(k3 != -1 && friendWorlds[k3] > 0)
                {
                    ...
                    aString1212 = "";
                    anInt1064 = 3;
                    aLong953 = friendNameHashes[k3];
                    aString1121 = "Enter message to send to " + friendDisplayNames[k3];
                }
            }
        }
        if(l == 454)
        ...
        if(l == 478)
        {
            Npc class30_sub2_sub4_sub1_sub1_7 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[i1];
            if(class30_sub2_sub4_sub1_sub1_7 != null)
            {
                method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, ((Actor) (class30_sub2_sub4_sub1_sub1_7)).anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, ((Actor) (class30_sub2_sub4_sub1_sub1_7)).anIntArray1500[0]);
                anInt914 = super.anInt27;
                anInt915 = super.anInt28;
                anInt917 = 2;
                anInt916 = 0;
        ...
        if(l == 1125)
        {
            ...
            Widget class9_4 = Widget.aClass9Array210[k];
            String s5;
        ...
        if(l == 169)
        {
            aClass30_Sub2_Sub2_1192.method397((byte)6, 185);
            aClass30_Sub2_Sub2_1192.method399(k);
            Widget class9_3 = Widget.aClass9Array210[k];
        ...
        if(l == 447)
        {
            ...
            itemUseWidgetId = k;
            itemUseItemId = i1;
            itemUseItemName = ItemDefinition.method198(i1).aString170;
            anInt1136 = 0;
            aBoolean1153 = true;
            return;
        }
    ...
    void updateSelectedDragTarget(int widgetId, int slot)
    {
        anInt1243 = 0;
        selectedDragWidgetId = widgetId;
        selectedDragSlot = slot;
        selectedDragState = 2;
        if(Widget.aClass9Array210[widgetId].anInt236 == anInt857)
            selectedDragState = 1;
        if(Widget.aClass9Array210[widgetId].anInt236 == anInt1276)
            selectedDragState = 3;
    }

    void routeToActor(Actor targetActor)
    {
        method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, targetActor.anIntArray1501[0], ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, targetActor.anIntArray1500[0]);
    }

    void markMenuInteractionCursor()
    {
        anInt914 = super.anInt27;
        anInt915 = super.anInt28;
        anInt917 = 2;
    ...
    PacketBuffer getOutboundBuffer()
    {
        return aClass30_Sub2_Sub2_1192;
    }

    int getSystemUpdateTimer()
    {
        return anInt1104;
    }

    void setSystemUpdateTimer(int systemUpdateTimer)
    {
        anInt1104 = systemUpdateTimer;
    }

    int getLoginThrottleTicks()
    {
        return anInt1011;
    }

    void setLoginThrottleTicks(int loginThrottleTicks)
    {
        anInt1011 = loginThrottleTicks;
    }

    boolean isGameReadyForTick()
    {
        return aBoolean1157;
    }

    void routeToTileAndMarkCursor(int tileX, int tileY)
    {
        boolean routed = method85(2, 0, 0, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 0, 0, tileY, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, tileX);
        if(!routed)
            method85(2, 0, 1, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 1, 0, tileY, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], false, tileX);
        markMenuInteractionCursor();
    }

    void beginWidgetSelection(int widgetId)
    {
        ...
        itemUseState = 0;
        aBoolean1153 = true;
        String actionPrefix = widget.aString222;
        if(actionPrefix.indexOf(" ") != -1)
            actionPrefix = actionPrefix.substring(0, actionPrefix.indexOf(" "));
        String actionSuffix = widget.aString222;
        if(actionSuffix.indexOf(" ") != -1)
            actionSuffix = actionSuffix.substring(actionSuffix.indexOf(" ") + 1);
        aString1139 = actionPrefix + " " + widget.aString218 + " " + actionSuffix;
        if(anInt1138 == 16)
        {
            aBoolean1153 = true;
            anInt1221 = 3;
    ...
    void beginReportAbuseFromAction(String actionText)
    {
        ...
        method147(537);
        aString881 = actionText.substring(markerIndex + 5).trim();
        aBoolean1158 = false;
        for(int widgetIndex = 0; widgetIndex < Widget.aClass9Array210.length; widgetIndex++)
        {
            if(Widget.aClass9Array210[widgetIndex] == null || Widget.aClass9Array210[widgetIndex].anInt214 != 600)
                continue;
            anInt1178 = anInt857 = Widget.aClass9Array210[widgetIndex].anInt236;
            break;
        }
    }

    void beginPrivateMessagePrompt(long targetNameHash)
    {
        int friendIndex = -1;
        for(int index = 0; index < friendCount; index++)
        {
            if(friendNameHashes[index] != targetNameHash)
                continue;
            friendIndex = index;
            break;
        }
        if(friendIndex == -1 || friendWorlds[friendIndex] <= 0)
            return;
        aBoolean1223 = true;
        anInt1225 = 0;
        aBoolean1256 = true;
        aString1212 = "";
        anInt1064 = 3;
        aLong953 = friendNameHashes[friendIndex];
        aString1121 = "Enter message to send to " + friendDisplayNames[friendIndex];
    }

    private void closeMainInterfacesIfOpen()
    {
        if(anInt1189 != -1)
        {
            anInt1189 = -1;
    ...
    private void clearDialogAndInputOverlayState()
    {
        if(anInt1276 != -1)
        {
            anInt1276 = -1;
    ...
    private void setMainAndSidebarInterfaces(int mainInterfaceId, int sidebarInterfaceId)
    {
        clearDialogAndInputOverlayState();
        anInt857 = mainInterfaceId;
        anInt1189 = sidebarInterfaceId;
        aBoolean1153 = true;
        aBoolean1103 = true;
        aBoolean1149 = false;
    }

    private void setTabInterface(int tabInterfaceId)
    {
        closeMainInterfacesIfOpen();
        anInt1276 = tabInterfaceId;
        aBoolean1223 = true;
        anInt857 = -1;
        aBoolean1149 = false;
    }

    private void clearAllOpenInterfaces()
    {
        closeMainInterfacesIfOpen();
        clearDialogAndInputOverlayState();
        anInt857 = -1;
    ...
    {
        anInt1251 = 0;
        int j = (((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 >> 7) + anInt1034;
        int k = (((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 >> 7) + anInt1035;
        i = 58 / i;
    ...
    public final void method71(int i)
    {
        ...
        for(int k = 0; k < Model.anInt1687; k++)
        {
            ...
            if(k1 == 2 && aClass25_946.method304(anInt918, i1, j1, l) >= 0)
            {
                ...
                if(itemUseState == 1)
                {
                    aStringArray1199[anInt1133] = "Use " + itemUseItemName + " with @cya@" + class46.aString739;
            ...
            if(k1 == 1)
            {
                Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[l1];
                if(class30_sub2_sub4_sub1_sub1.aClass5_1696.aByte68 == 1 && (((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 & 0x7f) == 64 && (((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 & 0x7f) == 64)
                {
                    for(int j2 = 0; j2 < anInt836; j2++)
                    {
                        Npc class30_sub2_sub4_sub1_sub1_1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[j2]];
                        if(class30_sub2_sub4_sub1_sub1_1 != null && class30_sub2_sub4_sub1_sub1_1 != class30_sub2_sub4_sub1_sub1 && class30_sub2_sub4_sub1_sub1_1.aClass5_1696.aByte68 == 1 && ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anInt1550 == ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 && ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anInt1551 == ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551)
                            method87(class30_sub2_sub4_sub1_sub1_1.aClass5_1696, anIntArray837[j2], false, j1, i1);
                    }

                    for(int l2 = 0; l2 < anInt891; l2++)
                    {
                        Player class30_sub2_sub4_sub1_sub2_1 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[anIntArray892[l2]];
                        if(class30_sub2_sub4_sub1_sub2_1 != null && ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anInt1550 == ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 && ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anInt1551 == ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551)
            ...
            if(k1 == 0)
            {
                Player class30_sub2_sub4_sub1_sub2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[l1];
                if((((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 & 0x7f) == 64 && (((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 & 0x7f) == 64)
                {
                    for(int k2 = 0; k2 < anInt836; k2++)
                    {
                        Npc class30_sub2_sub4_sub1_sub1_2 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[k2]];
                        if(class30_sub2_sub4_sub1_sub1_2 != null && class30_sub2_sub4_sub1_sub1_2.aClass5_1696.aByte68 == 1 && ((Actor) (class30_sub2_sub4_sub1_sub1_2)).anInt1550 == ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 && ((Actor) (class30_sub2_sub4_sub1_sub1_2)).anInt1551 == ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551)
                            method87(class30_sub2_sub4_sub1_sub1_2.aClass5_1696, anIntArray837[k2], false, j1, i1);
                    }

                    for(int i3 = 0; i3 < anInt891; i3++)
                    {
                        Player class30_sub2_sub4_sub1_sub2_2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[anIntArray892[i3]];
                        if(class30_sub2_sub4_sub1_sub2_2 != null && class30_sub2_sub4_sub1_sub2_2 != class30_sub2_sub4_sub1_sub2 && ((Actor) (class30_sub2_sub4_sub1_sub2_2)).anInt1550 == ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 && ((Actor) (class30_sub2_sub4_sub1_sub2_2)).anInt1551 == ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551)
            ...
            if(k1 == 3)
            {
                ...
                if(class19 != null)
                {
                    for(GroundItem class30_sub2_sub4_sub2 = (GroundItem)class19.first(5); class30_sub2_sub4_sub2 != null; class30_sub2_sub4_sub2 = (GroundItem)class19.next(8))
                    {
                        ItemDefinition class8 = ItemDefinition.method198(class30_sub2_sub4_sub2.anInt1558);
                        if(itemUseState == 1)
                        {
    ...
    public final void method8(int i)
    {
        ...
        friendDisplayNames = null;
        friendNameHashes = null;
        friendWorlds = null;
        aClass15_1110 = null;
        aClass15_1111 = null;
        aClass15_1107 = null;
    ...
    public final Component method11(int i)
    {
        anInt1007 += i;
        if(embeddedHostComponent != null)
            return embeddedHostComponent;
        if(SignLink.mainapp != null)
            return SignLink.mainapp;
        if(super.aFrame_Sub1_15 != null)
            return super.aFrame_Sub1_15.getGameComponent();
        else
            return this;
    }
            ...
            if(anInt1276 == -1)
            {
                ...
                if((j == 13 || j == 10) && aString887.length() > 0)
                {
                    ...
                    } else
                    {
                        ...
                        if(anInt863 == 2)
                            method77(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).aString1506, 2, "@cr2@" + aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703, aBoolean991);
                        else
                        if(anInt863 == 1)
                            method77(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).aString1506, 2, "@cr1@" + aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703, aBoolean991);
                        else
                            method77(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).aString1506, 2, aClass30_Sub2_Sub4_Sub1_Sub2_1126.aString1703, aBoolean991);
                        if(anInt1287 == 2)
                        {
                            anInt1287 = 3;
                            aBoolean1233 = true;
    ...
    public final void method74(int i, int j, int k)
    {
        ...
        for(int i1 = 0; i1 < 100; i1++)
        {
            ...
            if(k1 < -20)
                break;
            String s = ChatNameTagParser.parse(chatSenders[i1]).name;
            if(j1 == 0)
                l++;
    ...
    public final void method75(int i, Widget class9)
    {
        ...
        if(j >= 1 && j <= 100 || j >= 701 && j <= 800)
        {
            ...
            {
                class9.aString248 = friendDisplayNames[j];
                class9.anInt217 = 1;
                return;
            }
        }
        if(j >= 101 && j <= 200 || j >= 801 && j <= 900)
        {
            ...
            if(friendWorlds[j] == anInt957)
                class9.aString248 = "@gre@World-" + (friendWorlds[j] - 9);
            else
                class9.aString248 = "@yel@World-" + (friendWorlds[j] - 9);
            class9.anInt217 = 1;
            return;
        }
        if(j == 203)
        ...
        if(j >= 401 && j <= 500)
        {
            ...
            {
                class9.aString248 = TextUtils.method587(-45804, TextUtils.method584(ignoredNameHashes[j], (byte)-99));
                class9.anInt217 = 1;
                return;
            }
        }
        ...
        if(j == 327)
        {
            ...
            if(aBoolean1031)
            {
                ...
                class30_sub2_sub4_sub6.method470(SequenceDefinition.aClass20Array351[((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1511].anIntArray353[0], 40542);
    ...
    public final void method76(byte byte0)
    {
        ...
        for(int j = 0; j < 100; j++)
            ...
            {
                int k = chatTypes[j];
                ChatNameTagParser.ParsedChatName parsedName = ChatNameTagParser.parse(chatSenders[j]);
    ...
    public final void addChatMessage(String message, int chatType, String sender, boolean messageFilterFlag)
    {
        method77(message, chatType, sender, messageFilterFlag);
    }

    public final String formatWidgetValue(Widget widget, int valueIndex)
    {
        return method93(369, method124(341, widget, valueIndex));
    }
    ...
    long[] getIgnoredNameHashes()
    {
        return ignoredNameHashes;
    }
    ...
    long[] getFriendNameHashes()
    {
        return friendNameHashes;
    }

    String[] getFriendDisplayNames()
    {
    ...
    int getRecentChatWriteIndex()
    {
        return recentChatWriteIndex;
    }

    void setRecentChatWriteIndex(int recentChatWriteIndex)
    {
        this.recentChatWriteIndex = recentChatWriteIndex;
    }

    int[] getRecentChatIds()
    {
    ...
    int getSelectedDragState()
    {
        return selectedDragState;
    }

    int getSelectedDragSlot()
    {
        return selectedDragSlot;
    }

    int getSelectedDragWidgetId()
    {
        return selectedDragWidgetId;
    }
    ...
    int getItemUseWidgetId()
    {
        return itemUseWidgetId;
    }
    ...
    {
        if(embeddedHostComponent != null)
            return getConfiguredServerEndpoint().host().toLowerCase();
        if(SignLink.mainapp != null)
    ...
    public final void method82(int i)
    {
        ...
        if(super.anInt20 > 4 && super.anInt21 > 4 && super.anInt20 < 516 && super.anInt21 < 338)
            if(anInt857 != -1)
                method29(4, 13037, Widget.aClass9Array210[anInt857], super.anInt20, 4, super.anInt21, 0);
            else
                method71(33660);
        ...
        if(super.anInt20 > 553 && super.anInt21 > 205 && super.anInt20 < 743 && super.anInt21 < 466)
            if(anInt1189 != -1)
                method29(553, 13037, Widget.aClass9Array210[anInt1189], super.anInt20, 205, super.anInt21, 0);
            else
            if(anIntArray1130[anInt1221] != -1)
                method29(553, 13037, Widget.aClass9Array210[anIntArray1130[anInt1221]], super.anInt20, 205, super.anInt21, 0);
        ...
        if(super.anInt20 > 17 && super.anInt21 > 357 && super.anInt20 < 496 && super.anInt21 < 453)
            if(anInt1276 != -1)
                method29(17, 13037, Widget.aClass9Array210[anInt1276], super.anInt20, 357, super.anInt21, 0);
            else
    ...
    public final void method84(String s, String s1, boolean flag)
    {
        ...
        try
        {
            if(LoginProtocolHandler.shouldShowConnectingUi(flag))
            {
                loginStatusPrimary = "";
                loginStatusSecondary = "Connecting to server...";
                method135(true, false);
            }
            aClass24_1168 = new BufferedConnection(this, -978, openGameSocket(getConfiguredGamePort()));
            ...
            if(k == 1)
            {
                LoginProtocolHandler.sleepSilently(2000L);
                method84(s, s1, flag);
                return;
            }
            if(k == 2)
            {
                ...
                aClass30_Sub2_Sub4_Sub1_Sub2_1126 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[anInt889] = new Player();
                aClass19_1013.clear();
                aClass19_1056.clear();
            ...
            if(loginError != null)
            {
                loginStatusPrimary = loginError[0];
                loginStatusSecondary = loginError[1];
                return;
            }
            if(k == 15)
            {
            ...
            if(k == 21)
            {
                ...
                {
                    loginStatusPrimary = "You have only just left another world";
                    loginStatusSecondary = LoginProtocolHandler.resolveTransferCountdownMessage(k1);
                    method135(true, false);
                    LoginProtocolHandler.sleepSilently(1000L);
                }
            ...
            if(k == -1)
            {
                if(LoginProtocolHandler.shouldRetryAfterNoResponse(i1, anInt1038))
                {
                    LoginProtocolHandler.sleepSilently(2000L);
                    anInt1038++;
                    method84(s, s1, flag);
                ...
                String noResponseError[] = LoginProtocolHandler.resolveNoResponseError(i1);
                loginStatusPrimary = noResponseError[0];
                loginStatusSecondary = noResponseError[1];
                return;
            } else
            {
                System.out.println("response:" + k);
                loginStatusPrimary = "Unexpected server response";
                loginStatusSecondary = "Please try using a different world.";
                return;
            }
        }
        catch(IOException _ex)
        ...
        loginStatusSecondary = "Error connecting to server.";
    }
    ...
    {
        int routeState[] = {
            anInt1264, anInt1288, anInt1261, anInt1262
        };
        boolean routed = RoutePlanner.route(i, j, k, l, i1, j1, k1, l1, i2, j2, flag, k2, anInt918, aClass11Array1230, anIntArrayArray901, anIntArrayArray825, anIntArray1280, anIntArray1281, anInt1034, anInt1035, aClass30_Sub2_Sub2_1192, super.anIntArray30, routeState);
        anInt1264 = routeState[0];
        anInt1288 = routeState[1];
        anInt1261 = routeState[2];
        anInt1262 = routeState[3];
        return routed;
    }
    ...
    public final void method87(NpcDefinition class5, int i, boolean flag, int j, int k)
    {
        if(flag)
            aBoolean919 = !aBoolean919;
        anInt1133 = EntityMenuBuilder.buildNpcMenu(class5, i, j, k, anInt1133, itemUseState, itemUseItemName, anInt1136, anInt1138, aString1139, aClass30_Sub2_Sub4_Sub1_Sub2_1126.anInt1705, aStringArray1199, anIntArray1093, anIntArray1094, anIntArray1091, anIntArray1092);
    }
    ...
    public final void method88(int i, int j, Player class30_sub2_sub4_sub1_sub2, boolean flag, int k)
    {
        if(flag)
            return;
        anInt1133 = EntityMenuBuilder.buildPlayerMenu(i, j, k, class30_sub2_sub4_sub1_sub2, aClass30_Sub2_Sub4_Sub1_Sub2_1126, anInt1133, itemUseState, itemUseItemName, anInt1136, anInt1138, aString1139, aStringArray1127, aBooleanArray1128, aStringArray1199, anIntArray1093, anIntArray1094, anIntArray1091, anIntArray1092);
    }
    ...
    public final void method6()
    {
        ...
        if(ClientBootstrapLoader.shouldUseSunJavaLoopTuning())
            super.anInt6 = 5;
        if(aBoolean993)
        {
            //aBoolean1252 = true;
        ...
        try
        {
            ...
            aClass30_Sub2_Sub1_Sub1_1074 = mediaLayout.mapDotSprites[0];
            aClass30_Sub2_Sub1_Sub1_1075 = mediaLayout.mapDotSprites[1];
            aClass30_Sub2_Sub1_Sub1_1076 = mediaLayout.mapDotSprites[2];
            aClass30_Sub2_Sub1_Sub1_1077 = mediaLayout.mapDotSprites[3];
            aClass30_Sub2_Sub1_Sub1_1078 = mediaLayout.mapDotSprites[4];
            aClass30_Sub2_Sub1_Sub2_1024 = mediaLayout.scrollbar0;
            aClass30_Sub2_Sub1_Sub2_1025 = mediaLayout.scrollbar1;
            aClass30_Sub2_Sub1_Sub2_1143 = mediaLayout.redstone1;
            aClass30_Sub2_Sub1_Sub2_1144 = mediaLayout.redstone2;
            aClass30_Sub2_Sub1_Sub2_1145 = mediaLayout.redstone3;
            aClass30_Sub2_Sub1_Sub2_1146 = mediaLayout.redstone1Flipped;
            aClass30_Sub2_Sub1_Sub2_1147 = mediaLayout.redstone2Flipped;
            aClass30_Sub2_Sub1_Sub2_865 = mediaLayout.redstone1Mirrored;
            aClass30_Sub2_Sub1_Sub2_866 = mediaLayout.redstone2Mirrored;
            aClass30_Sub2_Sub1_Sub2_867 = mediaLayout.redstone3Mirrored;
            aClass30_Sub2_Sub1_Sub2_868 = mediaLayout.redstone1BothTransforms;
            ...
            aClass15_906 = backBuffers[3];
            aClass15_907 = backBuffers[4];
            aClass15_908 = backBuffers[5];
            aClass15_909 = backBuffers[6];
    ...
    private final void method91(PacketBuffer class30_sub2_sub2, int i, byte byte0)
    {
        ...
        while(class30_sub2_sub2.anInt1407 + 10 < i * 8) 
        {
            ...
            {
                aClass30_Sub2_Sub4_Sub1_Sub2Array890[j] = new Player();
            ...
            if(j1 > 15)
                j1 -= 32;
            class30_sub2_sub4_sub1_sub2.method445(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0] + j1, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0] + i1, l == 1, false);
        }
        class30_sub2_sub2.method420(true);
    }
    ...
    public final void method92(boolean flag)
    {
        ...
        if(super.anInt26 == 1)
        {
            ...
            if(i >= 0 && j >= 0 && i < 146 && j < 151)
            {
                ...
                int k1 = j * i1 + i * j1 >> 11;
                int l1 = j * j1 - i * i1 >> 11;
                int i2 = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 + k1 >> 7;
                int j2 = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 - l1 >> 7;
                boolean flag1 = method85(1, 0, 0, -11308, 0, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0], 0, 0, j2, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0], true, i2);
                if(flag1)
                {
                    aClass30_Sub2_Sub2_1192.method398(i);
                    ...
                    aClass30_Sub2_Sub2_1192.method399(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550);
                    aClass30_Sub2_Sub2_1192.method399(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551);
    ...
    public final void method94(int i)
    {
        ...
        if(aBoolean1176)
        {
            ...
            g.drawString("http://www.MoparScape.com", 50, 150);
        }
        if(aBoolean1252)
        {
            aBoolean831 = false;
    ...
    public final URL getCodeBase()
    {
        if(embeddedHostComponent != null)
            try
            {
                return getConfiguredServerEndpoint().toCodeBaseUrl();
            }
            catch(Exception _ex) { }
        if(SignLink.mainapp != null)
    ...
    public final void method96(int i, int j, Actor class30_sub2_sub4_sub1)
    {
        if(i != 46988)
            anInt1008 = -1;
    ...
    public final void method97(Actor class30_sub2_sub4_sub1, boolean flag)
    {
    ...
    public final void method98(Actor class30_sub2_sub4_sub1, byte byte0)
    {
    ...
    public final void method99(byte byte0, Actor class30_sub2_sub4_sub1)
    {
    ...
    public final void method100(Actor class30_sub2_sub4_sub1, int i)
    {
        if(i >= 0)
            return;
        ...
        {
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[class30_sub2_sub4_sub1.anInt1502];
            if(class30_sub2_sub4_sub1_sub1 != null)
            {
                int i1 = class30_sub2_sub4_sub1.anInt1550 - ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550;
                int k1 = class30_sub2_sub4_sub1.anInt1551 - ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551;
                if(i1 != 0 || k1 != 0)
        ...
        if(class30_sub2_sub4_sub1.anInt1502 >= 32768)
        {
            ...
            if(class30_sub2_sub4_sub1_sub2 != null)
            {
                int l1 = class30_sub2_sub4_sub1.anInt1550 - ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550;
                int i2 = class30_sub2_sub4_sub1.anInt1551 - ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551;
                if(l1 != 0 || i2 != 0)
    ...
    public final void method101(Actor class30_sub2_sub4_sub1, int i)
    {
        if(i >= 0)
            aBoolean919 = !aBoolean919;
    ...
    public final void method102(boolean flag)
    {
        ...
        aBoolean1153 = GameFrameHandler.applyMainViewportRedrawTriggers(anInt1023, aBoolean885, anInt948, anInt1189, anInt945, selectedDragState, dragState, aBoolean1153);
        if(aBoolean1153)
        {
            method36((byte)-81);
            aBoolean1153 = false;
        ...
        if(GameFrameHandler.shouldRedrawChatbox(selectedDragState, dragState, aString844, aBoolean885, anInt948))
            aBoolean1223 = true;
        if(aBoolean1223)
        {
            method18(6);
    ...
    public final boolean method103(Widget widget, boolean flag)
    {
        int i = widget.anInt214;
        if(flag)
            method6();
        if(i >= 1 && i <= 200 || i >= 701 && i <= 900)
        {
            ...
            if(i >= 101)
                ...
                i--;
            aStringArray1199[anInt1133] = "Remove @whi@" + friendDisplayNames[i];
            anIntArray1093[anInt1133] = 792;
            anInt1133++;
            aStringArray1199[anInt1133] = "Message @whi@" + friendDisplayNames[i];
        ...
        if(i >= 401 && i <= 500)
        {
            aStringArray1199[anInt1133] = "Remove @whi@" + widget.aString248;
    ...
    public final void method105(int drawModeGuard, int scrollY, int baseX, Widget parentWidget, int baseY)
    {
        if(WidgetInteractionHandler.shouldFlipMenuStateGuard(drawModeGuard))
            aBoolean991 = !aBoolean991;
        if(!WidgetInteractionHandler.canRenderWidgetTree(parentWidget, anInt1026, anInt1048, anInt1039))
            return;
        WidgetTreeRenderer.renderWidgetTree(
            ...
            anInt989,
            aBoolean1043,
            getSelectedDragState(),
            getSelectedDragSlot(),
            getSelectedDragWidgetId(),
            getItemUseState(),
            getItemUseSlot(),
            getItemUseWidgetId(),
            super.anInt20,
            ...
            anInt939,
            aBoolean1149,
            aClass30_Sub2_Sub1_Sub4_1270
        );
    }

    void setWidgetDragOffsetY(int dragOffsetY)
    {
    ...
    {
        PlayerUpdateMaskHandler.applyPlayerPublicChatUpdate((GameClient)this, player, packetBuffer, aClass30_Sub2_Sub2_834, ignoreCount, ignoredNameHashes, anInt1251, aBoolean991);
    }
    ...
    public final void method108(int i)
    {
        ...
        try
        {
            int j = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 + anInt1278;
            int k = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 + anInt1131;
        ...
        {
            SignLink.reporterror("glfc_ex " + ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 + "," + ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 + "," + anInt1014 + "," + anInt1015 + "," + anInt1069 + "," + anInt1070 + "," + anInt1034 + "," + anInt1035);
            throw new RuntimeException("eek");
        }
    }
    ...
    public final boolean method109(boolean flag, String s)
    {
        if(s == null)
            return false;
        for(int i = 0; i < friendCount; i++)
            if(s.equalsIgnoreCase(friendDisplayNames[i]))
                return true;
    ...
    public final void method112(int i)
    {
        ...
        if(anInt1018 != -1)
        {
            ...
            method105(8, 0, 0, Widget.aClass9Array210[anInt1018], 0);
        }
        if(anInt857 != -1)
        {
            method119(anInt945, false, anInt857);
            method105(8, 0, 0, Widget.aClass9Array210[anInt857], 0);
        }
        method70(184);
        if(!aBoolean885)
        {
    ...
    private final void method115(byte byte0)
    {
        ...
        if(anInt1023 == 2)
        {
            for(SceneObjectSpawnRequest class30_sub1 = (SceneObjectSpawnRequest)aClass19_1179.last(); class30_sub1 != null; class30_sub1 = (SceneObjectSpawnRequest)aClass19_1179.previous(false))
            {
    ...
    public final boolean method119(int i, boolean flag, int j)
    {
        ...
        if(flag)
            throw new NullPointerException();
        Widget class9 = Widget.aClass9Array210[j];
        for(int k = 0; k < class9.anIntArray240.length; k++)
        {
            if(class9.anIntArray240[k] == -1)
                break;
            Widget class9_1 = Widget.aClass9Array210[class9.anIntArray240[k]];
            if(class9_1.anInt262 == 1)
    ...
    public final int method120(int i)
    {
        ...
        if(anInt861 < 310)
        {
            int k = anInt858 >> 7;
            int l = anInt860 >> 7;
            int i1 = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 >> 7;
            int j1 = ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 >> 7;
        ...
        if((aByteArrayArrayArray1258[anInt918][((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 >> 7][((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 >> 7] & 4) != 0)
            j = anInt918;
        return j;
    }
            ...
            for(int j = 0; j < ignoreCount; j++)
                if(ignoredNameHashes[j] == l)
                {
                    ...
                    for(int k = j; k < ignoreCount; k++)
                        ignoredNameHashes[k] = ignoredNameHashes[k + 1];
    ...
    public final int method124(int i, Widget class9, int j)
    {
        ...
        try
        {
            ...
            do
            {
                ...
                if(j1 == 4)
                {
                    Widget class9_1 = Widget.aClass9Array210[ai[l++]];
                    int k2 = ai[l++];
                    if(k2 >= 0 && k2 < ItemDefinition.anInt203 && (!ItemDefinition.method198(k2).aBoolean161 || aBoolean959))
                    {
                ...
                if(j1 == 10)
                {
                    Widget class9_2 = Widget.aClass9Array210[ai[l++]];
                    int l2 = ai[l++] + 1;
                    if(l2 >= 0 && l2 < ItemDefinition.anInt203 && (!ItemDefinition.method198(l2).aBoolean161 || aBoolean959))
                    {
                ...
                if(j1 == 17)
                    byte0 = 3;
                if(j1 == 18)
                    k1 = (((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 >> 7) + anInt1034;
                if(j1 == 19)
                    k1 = (((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 >> 7) + anInt1035;
                if(j1 == 20)
                    k1 = ai[l++];
                if(byte0 == 0)
                {
    ...
    {
        if(anInt1133 < 2 && itemUseState == 0 && anInt1136 == 0)
            return;
        String s;
        if(itemUseState == 1 && anInt1133 < 2)
            s = "Use " + itemUseItemName + " with...";
        else
    ...
    public final void method126(boolean flag)
    {
        ...
        int j = 48 + ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
        int l2 = 464 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
        aClass30_Sub2_Sub1_Sub1_1263.method352(151, i, anIntArray1229, 256 + anInt1170, anIntArray1052, -236, l2, 5, 25, 146, j);
        aClass30_Sub2_Sub1_Sub1_1122.method352(33, anInt1185, anIntArray1057, 256, anIntArray968, -236, 25, 0, 0, 33, 25);
        for(int j5 = 0; j5 < anInt1071; j5++)
        {
            int k = (anIntArray1072[j5] * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
            int i3 = (anIntArray1073[j5] * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
        ...
        for(int k5 = 0; k5 < 104; k5++)
        {
            for(int l5 = 0; l5 < 104; l5++)
            {
                ...
                if(class19 != null)
                {
                    int l = (k5 * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                    int j3 = (l5 * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
        ...
        {
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[anIntArray837[i6]];
            if(class30_sub2_sub4_sub1_sub1 != null && class30_sub2_sub4_sub1_sub1.method449(aBoolean1224))
            {
                NpcDefinition class5 = class30_sub2_sub4_sub1_sub1.aClass5_1696;
                if(class5.anIntArray88 != null)
                    class5 = class5.method161(anInt877);
                if(class5 != null && class5.aBoolean87 && class5.aBoolean84)
                {
                    int i1 = ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1550 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                    int k3 = ((Actor) (class30_sub2_sub4_sub1_sub1)).anInt1551 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
        ...
        {
            Player class30_sub2_sub4_sub1_sub2 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[anIntArray892[j6]];
            if(class30_sub2_sub4_sub1_sub2 != null && class30_sub2_sub4_sub1_sub2.method449(aBoolean1224))
            {
                int j1 = ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1550 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                int l3 = ((Actor) (class30_sub2_sub4_sub1_sub2)).anInt1551 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
                boolean flag1 = false;
                long l6 = TextUtils.method583(class30_sub2_sub4_sub1_sub2.aString1703);
                for(int k6 = 0; k6 < friendCount; k6++)
                {
                    if(l6 != friendNameHashes[k6] || friendWorlds[k6] == 0)
                        continue;
                    flag1 = true;
                    break;
                }
        ...
        if(anInt855 != 0 && anInt1161 % 20 < 10)
        {
            ...
            {
                Npc class30_sub2_sub4_sub1_sub1_1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[anInt1222];
                if(class30_sub2_sub4_sub1_sub1_1 != null)
                {
                    int k1 = ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anInt1550 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                    int i4 = ((Actor) (class30_sub2_sub4_sub1_sub1_1)).anInt1551 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
                    method81(aClass30_Sub2_Sub1_Sub1_871, -760, i4, k1);
                }
            }
            if(anInt855 == 2)
            {
                int l1 = ((anInt934 - anInt1034) * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                int j4 = ((anInt935 - anInt1035) * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
            ...
            {
                Player class30_sub2_sub4_sub1_sub2_1 = aClass30_Sub2_Sub4_Sub1_Sub2Array890[anInt933];
                if(class30_sub2_sub4_sub1_sub2_1 != null)
                {
                    int i2 = ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anInt1550 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
                    int k4 = ((Actor) (class30_sub2_sub4_sub1_sub2_1)).anInt1551 / 32 - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
        ...
        if(anInt1261 != 0)
        {
            int j2 = (anInt1261 * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550 / 32;
            int l4 = (anInt1262 * 4 + 2) - ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551 / 32;
    ...
    public final void method127(boolean flag, Actor class30_sub2_sub4_sub1, int i)
    {
        if(!flag)
            anInt1008 = aClass30_Sub2_Sub2_1083.method408();
    ...
    public final void method129(boolean flag)
    {
        ...
        for(int j = 0; j < 100; j++)
            ...
            {
                int k = chatTypes[j];
                String s = ChatNameTagParser.parse(chatSenders[j]).name;
                if((k == 3 || k == 7) && (k == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s)))
                {
                    int l = 329 - i * 13;
                    if(super.anInt20 > 4 && super.anInt21 - 4 > l - 10 && super.anInt21 - 4 <= l + 3)
                    {
                        int i1 = aClass30_Sub2_Sub1_Sub4_1271.method383(anInt1116, "From:  " + s + chatMessages[j]) + 25;
                        if(i1 > 450)
                            i1 = 450;
            ...
            int l1, int i2, int j2)
    {
        ...
        if(class30_sub1 == null)
        {
            ...
            method89(false, class30_sub1);
            aClass19_1179.addFirst(class30_sub1);
        }
    ...
    public final void method135(boolean flag, boolean flag1)
    {
        ...
        if(flag1)
            return;
        if(loginScreenState == LOGIN_SCREEN_WELCOME)
        {
            int i = c1 / 2 + 80;
            aClass30_Sub2_Sub1_Sub4_1270.method382(0x75a9a9, c / 2, anInt939, aClass42_Sub1_1068.aString1333, i, true);
            i = c1 / 2 - 20;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "Welcome to MoparScape", i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
            aClass30_Sub2_Sub1_Sub2_967.method361(l - 73, 16083, k1 - 20);
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "Info", k1 + 5, true);
            l = c / 2 + 80;
            aClass30_Sub2_Sub1_Sub2_967.method361(l - 73, 16083, k1 - 20);
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "Play Now", k1 + 5, true);
        }
        if(loginScreenState == LOGIN_SCREEN_CREDENTIALS)
        {
            int j = c1 / 2 - 40;
            if(loginStatusPrimary.length() > 0)
            {
                aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, loginStatusPrimary, j - 15, true);
                aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, loginStatusSecondary, j, true);
                j += 30;
            } else
            {
                aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, loginStatusSecondary, j - 7, true);
                j += 30;
            }
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "Username: " + loginUsername + ((loginInputField == LOGIN_INPUT_USERNAME) & (anInt1161 % 40 < 20) ? "@yel@|" : ""), j);
            j += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 88, 0xffffff, "Password: " + TextUtils.method588(loginPassword, 0) + ((loginInputField == LOGIN_INPUT_PASSWORD) & (anInt1105 % 40 < 20) ? "@yel@|" : ""), j);
            j += 15;
            if(!flag)
            {
                int i1 = c / 2 - 80;
                ...
                aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, i1, anInt939, "Enter", l1 + 5, true);
                i1 = c / 2 + 80;
                aClass30_Sub2_Sub1_Sub2_967.method361(i1 - 73, 16083, l1 - 20);
                aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, i1, anInt939, "Cancel", l1 + 5, true);
            }
        }
        if(loginScreenState == LOGIN_SCREEN_PRIVATE_SERVER_INFO)
        {
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "To log into a private server", c1 / 2 - 60, true);
            int k = c1 / 2 - 35;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "click the Exit button below", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "then click the 'Play Now' button", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "fill in the required fields", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "for more help go to 'www.kaitnieks.com/scr'.", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Have Fun ~Moparisthebest", k, true);
            k += 15;
            int j1 = c / 2;
            int i2 = c1 / 2 + 50;
            aClass30_Sub2_Sub1_Sub2_967.method361(j1 - 73, 16083, i2 - 20);
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, j1, anInt939, "Exit", i2 + 5, true);
        }
        aClass15_1109.method238(171, 23680, super.aGraphics12, 202);
        if(aBoolean1255)
        {
    ...
    public final void method137(int i, PacketBuffer class30_sub2_sub2, int j)
    {
        ...
        if(j == 84)
        {
            ...
            if(j3 >= 0 && i6 >= 0 && j3 < 104 && i6 < 104)
            {
                ...
                if(class19_1 != null)
                {
                    for(GroundItem class30_sub2_sub4_sub2_3 = (GroundItem)class19_1.last(); class30_sub2_sub4_sub2_3 != null; class30_sub2_sub4_sub2_3 = (GroundItem)class19_1.previous(false))
                    {
        ...
        if(j == 105)
        {
            ...
            int i14 = l11 >> 4 & 0xf;
            int i16 = l11 & 7;
            if(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0] >= k3 - i14 && ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0] <= k3 + i14 && ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0] >= j6 - i14 && ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0] <= j6 + i14 && aBoolean848 && !aBoolean960 && anInt1062 < 50)
            {
        ...
        if(j == 215)
        {
            ...
            if(k6 >= 0 && j9 >= 0 && k6 < 104 && j9 < 104 && i12 != anInt884)
            {
                ...
                aClass19ArrayArrayArray827[anInt918][k6][j9].addFirst(class30_sub2_sub4_sub2_2);
                method25(k6, j9);
            }
            return;
        }
        ...
        if(j == 4)
        {
            ...
            if(i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104)
            {
                i5 = i5 * 128 + 64;
                l7 = l7 * 128 + 64;
                GraphicsObject class30_sub2_sub4_sub3 = new GraphicsObject(anInt918, anInt1161, 6, j15, k10, method42(anInt918, l7, true, i5) - l12, l7, i5);
                aClass19_1056.addFirst(class30_sub2_sub4_sub3);
            }
            return;
        }
        if(j == 44)
        {
            ...
            if(l10 >= 0 && i13 >= 0 && l10 < 104 && i13 < 104)
            {
                ...
                aClass19ArrayArrayArray827[anInt918][l10][i13].addFirst(class30_sub2_sub4_sub2_1);
                method25(l10, i13);
            }
            return;
        }
        ...
        if(j == 117)
        {
            ...
            if(l5 >= 0 && k8 >= 0 && l5 < 104 && k8 < 104 && j11 >= 0 && k13 >= 0 && j11 < 104 && k13 < 104 && i17 != 65535)
            {
                ...
                j11 = j11 * 128 + 64;
                k13 = k13 * 128 + 64;
                Projectile class30_sub2_sub4_sub4 = new Projectile(i21, l18, 46883, k19 + anInt1161, j20 + anInt1161, j21, anInt918, method42(anInt918, k8, true, l5) - i18, k8, l5, l15, i17);
                class30_sub2_sub4_sub4.method455(k19 + anInt1161, k13, method42(anInt918, k13, true, j11) - l18, j11, (byte)-83);
                aClass19_1013.addFirst(class30_sub2_sub4_sub4);
            }
        }
    }
    ...
    private final void method139(PacketBuffer class30_sub2_sub2, int i, int j)
    {
        ...
        for(int i1 = 0; i1 < k; i1++)
        {
            ...
            Npc class30_sub2_sub4_sub1_sub1 = aClass30_Sub2_Sub4_Sub1_Sub1Array835[j1];
            int k1 = class30_sub2_sub2.method419(1, 0);
            if(k1 == 0)
            {
    ...
    public final void method140(boolean flag)
    {
        ...
        if(loginScreenState == LOGIN_SCREEN_WELCOME)
        {
            ...
            {
                loginScreenState = LOGIN_SCREEN_PRIVATE_SERVER_INFO;
                loginInputField = LOGIN_INPUT_USERNAME;
            }
            ...
            if(super.anInt26 == 1 && super.anInt27 >= i - 75 && super.anInt27 <= i + 75 && super.anInt28 >= l - 20 && super.anInt28 <= l + 20)
            {
                ...
                loginScreenState = LOGIN_SCREEN_CREDENTIALS;
                loginInputField = LOGIN_INPUT_USERNAME;
                configuredServerAddress = GameServerEndpoint.DEFAULT_ADDRESS;
                return;
            }
        } else
        {
            if(loginScreenState == LOGIN_SCREEN_CREDENTIALS)
            {
                if(loginAutoSubmitPending)
                {
                    loginAutoSubmitPending = false;
                    anInt1038 = 0;
                    method84(loginUsername, loginPassword, false);
                    if(aBoolean1157)
                        return;
                }
                ...
                j += 15;
                if(super.anInt26 == 1 && super.anInt28 >= j - 15 && super.anInt28 < j)
                    loginInputField = LOGIN_INPUT_PASSWORD;
                j += 15;
                ...
                do
                {
                    ...
                    if(loginInputField == LOGIN_INPUT_USERNAME)
                    {
                        if(l1 == 8 && loginUsername.length() > 0)
                            loginUsername = loginUsername.substring(0, loginUsername.length() - 1);
                        if(l1 == 9 || l1 == 10 || l1 == 13)
                            loginInputField = LOGIN_INPUT_PASSWORD;
                        if(flag1)
                            loginUsername += (char)l1;
                        if(loginUsername.length() > 12)
                            loginUsername = loginUsername.substring(0, 12);
                    } else
                    if(loginInputField == LOGIN_INPUT_PASSWORD)
                    {
                        if(l1 == 8 && loginPassword.length() > 0)
    ...
    private final void method143(int i, PacketBuffer class30_sub2_sub2, int j)
    {
        ...
        {
            int l = anIntArray840[k];
            if(((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2Array890[l])).anInt1537 != anInt1161)
        ...
        for(int i1 = 0; i1 < anInt891; i1++)
            ...
            {
                SignLink.reporterror(loginUsername + " null entry in pl list - pos:" + i1 + " size:" + anInt891);
                throw new RuntimeException("eek");
            }
    ...
    public final boolean method145(boolean flag)
    {
        ...
        try
        {
            ...
            if(anInt1008 == 176)
            {
                ...
                if(anInt1193 != 0 && anInt857 == -1)
                {
                    ...
                    aString881 = "";
                    aBoolean1158 = false;
                    for(int k9 = 0; k9 < Widget.aClass9Array210.length; k9++)
                    {
                        if(Widget.aClass9Array210[k9] == null || Widget.aClass9Array210[k9].anInt214 != c)
                            continue;
                        anInt857 = Widget.aClass9Array210[k9].anInt236;
                        break;
                    }
            ...
            if(anInt1008 == 185)
            {
                InterfacePacketHandler.applyPlayerIdentityWidget(aClass30_Sub2_Sub2_1083, aClass30_Sub2_Sub4_Sub1_Sub2_1126);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 107)
            ...
            if(anInt1008 == 214)
            {
                ignoreCount = IncomingPacketDispatcher.applyIgnoreListSnapshot(aClass30_Sub2_Sub2_1083, anInt1007, ignoredNameHashes);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 166)
            ...
            if(anInt1008 == 253)
            {
                SocialPacketHandler.handleSocialRequestMessage(this, aClass30_Sub2_Sub2_1083, getIgnoreCount(), getIgnoredNameHashes(), anInt1251, aBoolean991);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 1)
            ...
            if(anInt1008 == 50)
            {
                int friendStatusUpdate[] = SocialPacketHandler.handleFriendStatusUpdate(this, aClass30_Sub2_Sub2_1083, getFriendCount(), anInt957, getFriendNameHashes(), getFriendDisplayNames(), getFriendWorlds(), aBoolean991);
                setFriendCount(friendStatusUpdate[0]);
            ...
            if(anInt1008 == 248)
            {
                ...
                setMainAndSidebarInterfaces(i5, k12);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 79)
            ...
            if(anInt1008 == 196)
            {
                setRecentChatWriteIndex(
                    SocialPacketHandler.handlePublicChatPacket(
                        this,
                        aClass30_Sub2_Sub2_1083,
                        anInt1007,
                        getRecentChatIds(),
                        getRecentChatWriteIndex(),
                        getIgnoreCount(),
                        getIgnoredNameHashes(),
                        anInt1251,
                        aBoolean991
                    )
                );
            ...
            if(anInt1008 == 246)
            {
                InterfacePacketHandler.applyWidgetItemModel(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 171)
            {
                InterfacePacketHandler.applyWidgetVisibility(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 142)
            ...
            if(anInt1008 == 126)
            {
                if(InterfacePacketHandler.applyWidgetText(aClass30_Sub2_Sub2_1083, anIntArray1130, anInt1221))
                    aBoolean1153 = true;
                anInt1008 = -1;
                return true;
            }
            ...
            if(anInt1008 == 8)
            {
                InterfacePacketHandler.applyWidgetNpcHeadModel(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 122)
            {
                InterfacePacketHandler.applyWidgetTextColor(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 53)
            {
                aBoolean1153 = true;
                InterfacePacketHandler.applyWidgetItemGridSnapshot(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 230)
            {
                InterfacePacketHandler.applyWidgetModelTransform(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 221)
            ...
            if(anInt1008 == 87)
            {
                int varpUpdate[] = InventoryPacketHandler.readVarpIntUpdate(aClass30_Sub2_Sub2_1083);
                int index = varpUpdate[0];
                int value = varpUpdate[1];
                anIntArray1045[index] = value;
                if(anIntArray971[index] != value)
                {
                    anIntArray971[index] = value;
                    method33(false, index);
                    aBoolean1153 = true;
                    if(anInt1042 != -1)
                        aBoolean1223 = true;
                }
            ...
            if(anInt1008 == 36)
            {
                int varpUpdate[] = InventoryPacketHandler.readVarpByteUpdate(aClass30_Sub2_Sub2_1083);
                int index = varpUpdate[0];
                int value = varpUpdate[1];
                anIntArray1045[index] = value;
                if(anIntArray971[index] != value)
            ...
            if(anInt1008 == 200)
            {
                InterfacePacketHandler.applyWidgetAnimation(aClass30_Sub2_Sub2_1083);
                anInt1008 = -1;
                return true;
            }
            if(anInt1008 == 219)
            ...
            {
                aBoolean1153 = true;
                InterfacePacketHandler.applyWidgetItemSlotUpdates(aClass30_Sub2_Sub2_1083, anInt1007);
                anInt1008 = -1;
                return true;
            }
        ...
        {
            String s2 = "T2 - " + anInt1008 + "," + anInt842 + "," + anInt843 + " - " + anInt1007 + "," + (anInt1034 + ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1500[0]) + "," + (anInt1035 + ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anIntArray1501[0]) + " - ";
    ...
    public final void method146(byte byte0)
    {
        ...
        if(!aBoolean1160)
        {
            ...
            method144(0, 600 + i * 3, i, anInt1014, method42(anInt918, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1551, true, ((Actor) (aClass30_Sub2_Sub4_Sub1_Sub2_1126)).anInt1550) - 50, k, anInt1015);
        }
        int j;
        if(!aBoolean1160)
            j = method120(111);
    ...
    {
        GameClientCoreConstructorInit.initialize(this);
    }

    void constructorInitWorldEntityAndBuffers()
    {
        ...
        aClass30_Sub2_Sub4_Sub1_Sub1Array835 = new Npc[16384];
        ...
        anInt888 = 2048;
        anInt889 = 2047;
        aClass30_Sub2_Sub4_Sub1_Sub2Array890 = new Player[anInt888];
        ...
        aByte923 = 25;
        ignoredNameHashes = new long[100];
        aBoolean926 = false;
        anInt927 = 0x332d25;
    ...
    void constructorInitUiWidgetsAndDeques()
    {
        ...
        aBoolean1080 = false;
        anInt1081 = -733;
        friendDisplayNames = new String[200];
        aClass30_Sub2_Sub2_1083 = PacketBuffer.method396(1, 9);
    }

    void constructorInitNetworkingAndContextMenus()
    {
    ...
    void constructorInitLateUiAndCollision()
    {
        aByte1194 = 5;
        ...
        aBoolean1233 = false;
        recentChatIds = new int[100];
    }

    void constructorInitScratchArraysAndDefaults()
    {
    ...
    private Player aClass30_Sub2_Sub4_Sub1_Sub2Array890[];
    ...
    private long ignoredNameHashes[];
    ...
    private String friendDisplayNames[];
    private PacketBuffer aClass30_Sub2_Sub2_1083;
    private int dragWidgetId;
    private int dragSlot;
    private int dragState;
    private int dragStartMouseX;
    /** Press Y at drag start; updated while dragging/scrolling item grids. */
    ...
    private int recentChatWriteIndex;
    private int anInt1170;
    private int anInt1171;
    private long aLong1172;
    private String loginUsername;
    private String loginPassword;
    private String configuredServerAddress;
    private boolean loginAutoSubmitPending;
    ...
    private int recentChatIds[];
    private int anIntArray1241[];
    private boolean aBoolean1242;
    private int anInt1243;
    private int selectedDragWidgetId;
    private int selectedDragSlot;
    private int selectedDragState;
    ...
    private String loginStatusPrimary;
    private String loginStatusSecondary;
    ...
    private int itemUseState;
    private int itemUseSlot;
    private int itemUseWidgetId;
    /** Item definition id selected for use-on-target flows (menu 447). */
    private int itemUseItemId;
    /** Display name of the item in use-on-target flows (menu 447); used in context menu captions. */
    String itemUseItemName;
    private int anInt1287;
    private static int anInt1288;
    private int anInt1289;
    public static int anInt1290;
    private static Component embeddedHostComponent;
