   ...
   //     aString1174 = "";
        ...
        try
        {
            ...
            if(k == 21)
            {
                for(int k1 = aClass24_1168.method268(); k1 >= 0; k1--)
                {
                    ...
                    aString1267 = LoginProtocolHandler.resolveTransferCountdownMessage(k1);
                    method135(true, false);
            ...
            if(k == -1)
            {
                ...
                aString1266 = noResponseError[0];
                aString1267 = noResponseError[1];
                return;
            } else
            {
    ...
    public final void method140(boolean flag)
    {
        ...
        if(anInt833 == 0)
        {
            ...
            {
                aString1266 = "";
                aString1267 = "Enter your username, password and Server IP.";
                anInt833 = 2;
                anInt1216 = 0;
                return;
            }
