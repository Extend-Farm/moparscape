...
final class WorldSceneObjectAssembler {
  ...
  WorldSceneObject assemble(
    ...
    WorldSceneObjectGeometry geometry = definition == null
        ? null
        : objectGeometryBuilder.build(definition, placement.orientation(), sizeX, sizeY, modelIds);
