    ...
    implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener
{
    ...
    public void run()
    {
        ...
        method11(0).requestFocus();
        method11(0).requestFocusInWindow();
        if(aFrame_Sub1_15 != null)
        {
            aFrame_Sub1_15.addKeyListener(this);
            aFrame_Sub1_15.addFocusListener(this);
            aFrame_Sub1_15.addWindowListener(this);
            aFrame_Sub1_15.requestGameFocus();
        }
    ...
    public Component method11(int i)
    {
        ...
        if(aFrame_Sub1_15 != null)
            return aFrame_Sub1_15.getGameComponent();
        else
            return this;
    }
    ...
    {
        Component component = method11(0);
