...
final class GameplayCameraController {
  ...
  GameplayCameraController(LongSupplier nanoClock) {
    this.nanoClock = Objects.requireNonNull(nanoClock, "nanoClock");
  }

  void adjust(float yawDeltaDegrees, float pitchDeltaDegrees) {
  ...
  record CameraOrbitOffsets(float yawOffsetDegrees, float pitchOffsetDegrees) {
  }
}
