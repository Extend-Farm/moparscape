# Game Client Module (`moparscape-reference/server/moparscape`)
...
- it expects the reference emulator in `moparscape-reference/client/` to be running first
...
- `moparscape-reference/server/moparscape/` -> reference desktop client
- `moparscape-reference/client/` -> reference emulator/server
