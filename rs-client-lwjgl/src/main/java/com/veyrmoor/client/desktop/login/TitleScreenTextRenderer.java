...
public final class TitleScreenTextRenderer {
  ...
  private static final String LOADING_HEADING = "Veyrmoor is loading...";
  ...
  private void renderWelcome(int[] pixels) {
    drawCenteredBold(pixels, "Welcome to Veyrmoor", TITLE_BOX_CENTER_X, TITLE_BOX_TOP + 57, TITLE_YELLOW);
  ...
  private void renderPrivateServerInfo(int[] pixels) {
    ...
    plainFont.drawText(
        ...
        CANVAS_HEIGHT,
        "Have Fun ~Veyrmoor",
        TITLE_BOX_CENTER_X - plainFont.measureText("Have Fun ~Veyrmoor") / 2,
  ...
  private String normalizeCredentialsStatus(String statusText) {
    ...
    return switch (statusText) {
      case "Booting", "Assets ready", "Welcome to Veyrmoor" -> DEFAULT_CREDENTIALS_PROMPT;
      default -> statusText;
    };
  }
