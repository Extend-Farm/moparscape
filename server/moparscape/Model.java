...
public class Model extends Class30_Sub2_Sub4
{
    ...
    {
        int l1 = Rasterizer3D.anInt1466;
        int i2 = Rasterizer3D.anInt1467;
            ...
            int l1, int i2)
    {
        ...
        if(k3 / i3 >= Rasterizer2D.anInt1386)
            return;
        int l3 = j3 + anInt1650 << 9;
        if(l3 / i3 <= -Rasterizer2D.anInt1386)
            return;
        int i4 = k1 * k - j2 * j >> 16;
        ...
        if(i2 > 0 && aBoolean1684)
        {
            ...
            int i6 = anInt1685 - Rasterizer3D.anInt1466;
            int k6 = anInt1686 - Rasterizer3D.anInt1467;
        ...
        int l5 = Rasterizer3D.anInt1466;
        int j6 = Rasterizer3D.anInt1467;
        int l6 = 0;
        int i7 = 0;
        if(i != 0)
        {
            ...
            if(anIntArray1637 == null || anIntArray1637[k] != -1)
            {
                ...
                } else
                {
                    ...
                    if((i3 - l3) * (anIntArray1666[j2] - anIntArray1666[k1]) - (anIntArray1666[l] - anIntArray1666[k1]) * (k4 - l3) > 0)
                    {
                        ...
                        if(i3 < 0 || l3 < 0 || k4 < 0 || i3 > Rasterizer2D.anInt1385 || l3 > Rasterizer2D.anInt1385 || k4 > Rasterizer2D.anInt1385)
    ...
    private final void method484(int i)
    {
        ...
        if(anIntArray1639 == null)
            ...
            Rasterizer3D.anInt1465 = anIntArray1639[i];
        int i1;
        if(anIntArray1637 == null)
            i1 = 0;
        else
        ...
        if(i1 == 0)
        {
            Rasterizer3D.method374(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1635[i], anIntArray1636[i]);
            return;
        }
        if(i1 == 1)
        {
            Rasterizer3D.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], anIntArray1691[anIntArray1634[i]]);
            return;
        }
        if(i1 == 2)
        {
    ...
    {
        int j = Rasterizer3D.anInt1466;
        int k = Rasterizer3D.anInt1467;
        int l = 0;
        ...
        if((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0)
        {
            ...
            if(l == 3)
            {
                if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > Rasterizer2D.anInt1385 || j4 > Rasterizer2D.anInt1385 || j5 > Rasterizer2D.anInt1385)
                ...
                if(l7 == 0)
                    Rasterizer3D.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2]);
                else
                if(l7 == 1)
                    Rasterizer3D.method376(i7, j7, k7, j3, j4, j5, anIntArray1691[anIntArray1634[i]]);
                else
                if(l7 == 2)
                {
                    ...
                    Rasterizer3D.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[k9], anIntArray1668[k10], anIntArray1668[k11], anIntArray1669[k9], anIntArray1669[k10], anIntArray1669[k11], anIntArray1670[k9], anIntArray1670[k10], anIntArray1670[k11], anIntArray1640[i]);
                } else
                if(l7 == 3)
                {
                    ...
                    Rasterizer3D.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[l9], anIntArray1668[l10], anIntArray1668[l11], anIntArray1669[l9], anIntArray1669[l10], anIntArray1669[l11], anIntArray1670[l9], anIntArray1670[l10], anIntArray1670[l11], anIntArray1640[i]);
                }
            }
            if(l == 4)
            {
                if(j3 < 0 || j4 < 0 || j5 < 0 || j3 > Rasterizer2D.anInt1385 || j4 > Rasterizer2D.anInt1385 || j5 > Rasterizer2D.anInt1385 || anIntArray1678[3] < 0 || anIntArray1678[3] > Rasterizer2D.anInt1385)
                    Rasterizer3D.aBoolean1462 = true;
                int i8;
                if(anIntArray1637 == null)
                    i8 = 0;
                ...
                {
                    Rasterizer3D.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2]);
                    Rasterizer3D.method374(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0], anIntArray1680[2], anIntArray1680[3]);
                    return;
                }
                if(i8 == 1)
                {
                    ...
                    Rasterizer3D.method376(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], l8);
                    return;
                }
                if(i8 == 2)
                {
                    ...
                    Rasterizer3D.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[i10], anIntArray1668[i11], anIntArray1668[i12], anIntArray1669[i10], anIntArray1669[i11], anIntArray1669[i12], anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], anIntArray1640[i]);
                    Rasterizer3D.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0], anIntArray1680[2], anIntArray1680[3], anIntArray1668[i10], anIntArray1668[i11], anIntArray1668[i12], anIntArray1669[i10], anIntArray1669[i11], anIntArray1669[i12], anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], anIntArray1640[i]);
                    return;
                }
                if(i8 == 3)
                {
                    ...
                    Rasterizer3D.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[j10], anIntArray1668[j11], anIntArray1668[j12], anIntArray1669[j10], anIntArray1669[j11], anIntArray1669[j12], anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], anIntArray1640[i]);
                    Rasterizer3D.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[j10], anIntArray1668[j11], anIntArray1668[j12], anIntArray1669[j10], anIntArray1669[j11], anIntArray1669[j12], anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], anIntArray1640[i]);
                }
            }
        }
    }
    ...
    static 
    {
        anIntArray1689 = Rasterizer3D.anIntArray1470;
        anIntArray1690 = Rasterizer3D.anIntArray1471;
        anIntArray1691 = Rasterizer3D.anIntArray1482;
        anIntArray1692 = Rasterizer3D.anIntArray1469;
    }
}
