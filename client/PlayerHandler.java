...
/**
 * <p>Title: PlayerHandler</p>
 *
 * <p>Description: Handles all Players online</p>
 *
 * <p>Copyright: Copyright (c) 2006 daiki</p>
 *
...
public class PlayerHandler {
    ...
    /**
     * <p>Called when first static method in this class is called</p>
     */
    static {
    ...
    /**
     * <p>Called when a new Player Client is connected</p>
     * <p><b>NOTE</b>:connectedFrom is pointless, we'll remove this one-day</p>
     *
     * @param s             Socket
     * @param connectedFrom String
     */
...
//		} while(i != playerSlotSearchStart);
    ...
    /**
     * <p>Returns the number of players online</p>
     *
     * @return int
     */
    ...
    /**
     * <p>Updates the Names of all the players online</p>
     */
    ...
    /**
     * <p>Returns whether any players with the specified username are online</p>
     *
    ...
    /**
     * <p>Where PlayerHandler does it's thing</p>
     * <p>Calles aprox. every 500ms</p>
     */
    ...
    /**
     * <p>Updates this Player if they are an NPC (I hate the way this thing is designed)</p>
     *
     * @param plr Player
     * @param str stream
     */
    ...
    /**
     * <p>Updates this Player Object</p>
     * <p>should actually be moved to client.java because it's very client specific</p>
     *
     * @param plr Player
     * @param str stream
     */
    ...
    /**
     * <p>Stops PlayerHandler from updating this Player anymore</p>
     *
     * @param plr Player
     */
    ...
    /**
     * <p>Saves the game for this Player</p>
     * <p>Returns whether the save was successful</p>
     *
     * @param plr Player
     * @return boolean
     */
    ...
    /**
     * <p>Is this ever used?</p>
     *
     * @param str  String
     * @param ID   int
     * @param Name String
     */
    public static void println_debug(String str, int ID, String Name) {
