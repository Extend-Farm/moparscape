...
import io.github.ffakira.rsps.sim.GameSystem;
import io.github.ffakira.rsps.sim.MovementSystem;
import io.github.ffakira.rsps.sim.PlayerSpawnedEvent;
import io.github.ffakira.rsps.sim.SimulationWorld;
import io.github.ffakira.rsps.sim.SpawnPlayerCommand;
import io.github.ffakira.rsps.sim.WorldCommand;
import io.github.ffakira.rsps.sim.WorldCommandProcessor;
...
public class WorldShardActor extends MailboxActor<WorldShardMessage> {
  ...
  public CompletableFuture<WorldShardAdmission> enterCharacter(
      io.github.ffakira.rsps.persistence.CharacterSnapshot characterSnapshot
  ) {
